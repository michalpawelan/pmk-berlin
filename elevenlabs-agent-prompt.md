...
- **Confirmation (Bierzmowanie / Firmung):** from age fifteen. Register in September — **the online form on the website is enough**, only a missing baptism certificate has to be handed in at the office. Preparation weekly from October. Celebration May or June of the following year.
